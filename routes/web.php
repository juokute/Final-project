...
Route::get('/api/stories', [StoryController::class, 'getStories'])->name('api.stories');
...
Route::get('/story', [StoryController::class, 'newStory'])->middleware('auth')->name('story');
...
Route::post('/stories/{id}/heart', [StoryController::class, 'toggleHeart'])->middleware('auth')->name('stories.heart');
Route::post('/stories/{id}/donate', [StoryController::class, 'donate'])->middleware('auth')->name('stories.donate');
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/admin/tags', [StoryController::class, 'tagsPanel'])->name('admin.tags');
